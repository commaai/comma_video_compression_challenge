...
sidecar corrections are folded into them, and 2,198 net one- and two-step code
...
- The 2,198 net latent-code adjustments (±1/±2 grid steps, CPU-axis selected) themselves, found by an
