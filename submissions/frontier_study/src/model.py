...
"""HNeRV-style decoder. Architecture + weights are byte-identical to PR #95 by
@AaronLeslie138 (https://github.com/commaai/comma_video_compression_challenge/pull/95),
reused unchanged. This submission trains no new model; it is a reproduction + study.
"""
import torch
